...
const Hero = () => {
  return (
    <main className="flex flex-col min-h-screen w-full small:mb-32 pt-28 small:pt-32 screen-path">
      <div className="w-full justify-between gap-12 small:gap-0 flex flex-col small:flex-row small:pl-28">
        <div className="flex flex-col gap-6 items-start pt-10 small:pr-4 px-6 small:px-0">
          ...
          <p
            className={`${styles.parraph} pr-2 small:pr-0 text-sm small:text-lg`}
          >
        ...
        <img
          src="/desktop.webp"
          alt="desktop"
          className="hidden small:block max-w-[62%]"
        />
        <img
          src="/desktop-responsive.png"
          alt="desktop"
